      ...
      <section className="py-24 bg-white dark:bg-[#020617]" id="kontak">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-8 max-w-4xl mx-auto">
            {/* Direct Contact Info */}
            <div
              className="bg-emerald-50 dark:bg-emerald-900/10 p-10 rounded-[2.5rem] border border-emerald-100 dark:border-emerald-800 flex flex-col items-center flex-1 justify-center text-center shadow-sm hover:shadow-xl transition-shadow">
